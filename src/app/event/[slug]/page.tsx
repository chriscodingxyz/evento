      ...
      <section className="relative overflow-hidden flex justify-center items-center py-14 md:py-20">
        ...
        <div className="z-1 flex flex-col gap-6 lg:gap-16 lg:flex-row relative">
          ...
          <div className=" flex flex-col">
            ...
            <button className="bg-white/20 text-lg capitalize bg-blur mt-5 lg:mt-auto w-[95vw] sm:w-full py-2 border-white/10  border-2 hover:scale-105 active:scale-[1.02] focus:scale-105 transition">
              Get Tickets
            </button>
          </div>
        </div>
